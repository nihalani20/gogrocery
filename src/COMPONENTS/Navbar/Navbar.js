    ...
    <nav>
      <div className='s1'>
        ...
        <div className='searchbar'>
          ...
          <button>
 <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' style={{ strokeWidth: 1.5, stroke: 'currentColor', width: '1.5rem', height: '1.5rem' }}>
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" style={{ strokeWidth: 1.5, stroke: 'currentColor', width: '1.5rem', height: '1.5rem' }}>
      ...
      <Dropdown.Menu>
        ...
        <Dropdown.Item href="#/action-3">Fresh Diary Products</Dropdown.Item>
      </Dropdown.Menu>
    </Dropdown>
